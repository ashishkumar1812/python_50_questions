...
📌 Overview
This project is designed to practice and strengthen core Python concepts in a structured and interactive way using Jupyter Notebook.

💡 Key Features
✅ Solutions written using functions
✅ Proper use of exception handling (try-except)
